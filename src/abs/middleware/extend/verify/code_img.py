...
class CodeImg(object):

    def __init__(self, width=130, height=30, code_count=4, font_size=32, point_count=10, line_count=3, img_format='png'):
        """
    ...
    def get_code_img(self):
        ...
        ttf_file = os.path.join(path, 'kumo.ttf')
        font = ImageFont.truetype(ttf_file, size=self.font_size)
