# Generated by Django 3.0.3 on 2020-05-19 16:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('unique_number', models.CharField(max_length=64, unique=True, verbose_name='唯一逻辑编码')),
                ('identification', models.CharField(default='', max_length=24, null=True, verbose_name='身份证号')),
                ...
                ('address', models.TextField(default='', null=True, verbose_name='详细地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('create_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='创建时间')),
                ('certification', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='model.UserCertification')),
            ],
            options={
                'db_table': 'staff_info',
            },
