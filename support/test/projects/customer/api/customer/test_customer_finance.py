...
class CustomerTransactionTestCase(APITestCase):
    ...
    def test_customer_transaction_get(self):
        ...
        result = self.access_customer_api(api = api, transaction_id = transaction_id)
    ...
    def test_customer_transaction_statistics_montyly(self):
        ...
        result = self.access_customer_api(api = api)
