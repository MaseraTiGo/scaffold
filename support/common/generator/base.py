...
class BaseGenerator(object):
    ...
    def get_input_results(self):
        return {
            generator.get_key(): generator.get_result()
    ...
    def generate_exec(self):
        ...
        logger.info(
            "System is going to generate {}, the staff totle is {}."
        ...
        logger.info(
            "System have finished to generate {} data."
            .format(self.get_key())
        )
        return result
    ...
    def generate(self, *args, **kwargs):
        ...
        if not self.has_result():
            ...
            if self._result is None:
                raise Exception(
                    "{}_create function is need to return result"
